...
public class CatalogItemNotFoundExceptionHandler extends RestExceptionHandler {
    ...
    public ErrorInfo handleCatalogItemNotFoundException(CatalogItemNotFoundException exception, WebRequest request) {
        return buildErrorResponse(exception, request, HttpStatus.NOT_FOUND, "The requested item was not found, please check the item id").getBody();
    }
}